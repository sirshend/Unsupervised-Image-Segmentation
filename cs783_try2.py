...
parser.add_argument('--minLabels', metavar='minL', default=6, type=int, 
                    help='minimum number of labels')
parser.add_argument('--lr', metavar='LR', default=0.1, type=float, 
                    help='learning rate')
parser.add_argument('--nConv', metavar='M', default=4, type=int, 
...
# parser.add_argument('--output', metavar='FILENAME2',
                    # help='output image file name', required=False)
...
for batch_idx in range(args.maxIter):
    ...
    if args.visualize:
        ...
        # na = args.input.strip().split('/')
        # na = na[len(na)-1] 
        # cv2.imwrite("output/"+ str(na),im_target_rgb)
        # print("output/"+ str(na))
        cv2.waitKey(5)
